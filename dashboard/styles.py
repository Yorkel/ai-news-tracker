...
from .palette import (
    ACCENT, ACCENT_HOVER, ACCENT_SOFT, DUSK, DUSK_MUTED, GOLD, GOLD_SOFT, INFO, INFO_SOFT, INK, INK_SOFT, REJECT, REJECT_HOVER, REJECT_SOFT, RULE, SURFACE_ALT, SURFACE_SUNK,
)
